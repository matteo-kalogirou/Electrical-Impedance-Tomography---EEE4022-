...
results_path = './NewResults/hom_1k_1vpp_';  % double delimitted by ';'
...
inh_path = './NewResults/banana_6oclk_1k_1vpp/';  % double delimitted by ';'
ban_6oclk_data = importEITinput(inh_path);

inh_path = './NewResults/banana_12oclk_1k_1vpp/';  % double delimitted by ';'
ban_12oclk_data = importEITinput(inh_path);
%%
...
subplot(121); show_fem(img_ban_6); title('6 o`clock');
img_ban_12 = inv_solve(imdl, hom_exp_data, ban_12oclk_data);
subplot(122); show_fem(img_ban_12); title('12 o`clock');
